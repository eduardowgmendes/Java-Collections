...
|`Map.Entry<K,V> pollFirstEntry( )`| Retorna a primeira entrada, removendo-a no processo. Já que o mapa é classificado, ela será a entrada de chave com menor valor. Se o mapa estiver vazio, null será retornado.|
|`Map.Entry<K,V> pollLastEntry( )`| Retorna a última entrada, removendo-a no processo. Já que o mapa é classificado, ela será a entrada de chave com maior valor. Se o mapa estiver vazio, null será retornado.|
