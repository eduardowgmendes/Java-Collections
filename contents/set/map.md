...
|`SortedMap<K, V> subMap(K start, K end)`|Retorna um SortedMap contendo os elementos do mapa
chamador que estejam entre início e fim. O mapa resultante é uma visão do mapa chamador.|
